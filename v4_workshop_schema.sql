-- Consolidated Technician & Workshop Schema for MotorGAs
-- This script adds the missing tables for Tickets, Inspections, Photos, Approvals, and Logs.
